...
#include "aimasa2.h"
#include "SimpleFormationDC.h"


// Sets default values
ASimpleFormationDC::ASimpleFormationDC() {
...
void ASimpleFormationDC::BeginPlay() {
	Super::BeginPlay();
...
// Called every frame
void ASimpleFormationDC::Tick(float DeltaTime) {
...
void ASimpleFormationDC::init() {
	...
	RRT rrt1(150, map, std::bind(&ASimpleFormationDC::calc_path, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4), v_max, a_max);
	...
	RRT rrt2(750, map, std::bind(&ASimpleFormationDC::calc_path_formation, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4), v_max, a_max);
...
std::shared_ptr<Path> ASimpleFormationDC::calc_path(FVector pos0, FVector vel0, FVector pos1, FVector vel1) {
...
std::shared_ptr<Path> ASimpleFormationDC::calc_path_formation(FVector pos0, FVector vel0, FVector pos1, FVector vel1) {
	DynamicCarPaths* dp = new DynamicCarPaths(pos0, vel0, pos1, vel1, v_max, map->phi_max, map->L_car, a_max);
...
float ASimpleFormationDC::formation_error() {
	float error = 0;
...
float ASimpleFormationDC::formation_error(std::vector<std::vector<std::shared_ptr<RRTNode>>> & path, float t) {
...
void ASimpleFormationDC::map_goals() {
...
float ASimpleFormationDC::total_cost(std::vector<std::vector<std::shared_ptr<RRTNode>>> & path, int resolution) {
