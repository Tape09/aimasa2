...
class AIMASA2_API DynamicPointPaths : public Path {
public:
	...
	DynamicPointPaths(FVector pos0, FVector vel0, FVector pos1, FVector vel1, float v_max, float phi_max, float L_car, float a_max);
	~DynamicPointPaths();
